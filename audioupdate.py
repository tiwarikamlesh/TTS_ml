...
def update_metadata(input_folder, output_folder):
    ...
    for i in range(1, 26):  # change  this to the number of files in your folder + 1
...
if __name__ == "__main__":
    input_folder = r"C:\Users\Dell\Desktop\sopfinal\gitsop\wavs"  # your path
    output_folder = r"C:\Users\Dell\Desktop\sopfinal\gitsop\output"  # your path
